...
func (o *{{$txt.LocalTable.NameGo}}) {{$txt.Function.Name}}G(mods ...qm.QueryMod) {{$varNameSingular}}Query {
	return o.{{$txt.Function.Name | IDFK}}(boil.GetDB(), mods...)
}

// {{$txt.Function.Name}} pointed to by the foreign key.
func (o *{{$txt.LocalTable.NameGo}}) {{$txt.Function.Name | IDFK}}(exec boil.Executor, mods ...qm.QueryMod) ({{$varNameSingular}}Query) {
